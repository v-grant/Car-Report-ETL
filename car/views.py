...
def mcrequest_report(request, *args, **kwargs):
  if request.method == 'POST':
    ...
    return render(request, "search-result.html" , {'data': report})
  return render(request, "search-result.html" , {'datar': 'No data fetched'})
...
def scrape_reportinfo(soup):
    ...
    post_values ={}
    for x in reports:
        post_values['driver_name'] =x.get("Name")
